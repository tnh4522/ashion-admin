...
function LogoAdmin() {
    ...
    return (
        <div
            className={href.includes("login") || href.includes("register") ? "app-brand justify-content-center" : "app-brand demo"}>
            <Link to={href.includes("login") || href.includes("register") ? "" : "/"} className="app-brand-link gap-2">
